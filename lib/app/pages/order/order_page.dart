...
class _OrderPageState extends BaseState<OrderPage, OrderController> {
  ...
  void _showConfirmProductDialog(OrderConfirmDeleteProductSate state) {
    showDialog(
      context: context,
      ...
      listener: (context, state) {
        state.status.matchAny(
          ...
          confirmRemoveProduct: () {
            hideLoader();
            if (state is OrderConfirmDeleteProductSate) {
              _showConfirmProductDialog(state);
            }
          },
          emptyBag: () {
            showInfo(
                'Sua sacola está vazia, por favor seleciona um produto para realizar seu pedido');
